...
path = "../../result/simulation_data/"

data_name = ['exp', 'logn', 'uniform', 'clayton']

path_exp = "%s/%s/" %(path, data_name[0])
path_logn = "%s/%s/" %(path, data_name[1])
path_uniform = "%s/%s/" %(path, data_name[2])
path_clayton = "%s/%s/" %(path, data_name[3])
